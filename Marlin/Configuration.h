...
#define STRING_CONFIG_H_AUTHOR "(Trivalik)" // Who made the changes.
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  //skynet original, was working for PLA
  //#define  DEFAULT_Kp 21.0
  //#define  DEFAULT_Ki 1.25
  //#define  DEFAULT_Kd 86.0

  //we measured with our A6 with 230°C
  #define  DEFAULT_Kp 23.88
  #define  DEFAULT_Ki 1.29
  #define  DEFAULT_Kd 110.9
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_PROBE_PT_1_Y 165      // of the mesh.
